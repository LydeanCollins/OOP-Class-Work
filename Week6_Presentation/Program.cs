    ...
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            do
            {
                ...
                try //Must have when expecting exceptions
                {
                    mainMenuChoice = Convert.ToInt32(Console.ReadLine());
                }
                catch (FormatException)
                {
                    Console.WriteLine("Invalid input String. Please enter a number corresponding to the menu options.");
                    mainMenuChoice = 5; 
                }
                catch (ArgumentException)
                {
                    Console.WriteLine("Invalid input range. Please enter a number corresponding to the menu options 1-5.");
                    mainMenuChoice = 5; 
                }
                ...
                switch (attendanceMenuChoice) {
                    case 1:
                        try
                        {
                            ...
                            {
                                Console.WriteLine("Invalid input format. Please enter a valid number for the group ID.");
                                Console.ReadKey();
                                throw;
                            }
